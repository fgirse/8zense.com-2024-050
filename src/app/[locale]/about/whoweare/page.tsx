...
import Signature from "@/public/assets/images/arrow06.svg";
...
lg:text-[9rem]"
          ...
          <div className="bg-neutral-200/20 mb-16">
            <p className="text-base text:justify px-7 text-justify   md:text-lg text-slate-700 my-4 md:my-6">
              <span className="text-orange">8zense.com</span> enstand aus einer
              Intuition heraus, obwelcher Fernanda sich immer wieder die Frage
              stellte, ob gutes Design nur denjenigen Menschen zusteht die dies
              sich auch leisten können. Als studierte Innenarchitektin hat
          ...
          <div className="bg-zenseGrey/30  h-1/3 grid grid-cols-[5vw_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr] grid-rows-[1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr_1fr]  items-stretch gap-0 w-[100vw]">
            ...
            <div className="bg-zenseGrey/10 col-span-4 row-span-3 col-start-3 row-start-7">
              <p className="text-xs lg:text-xl leading-3 mt-2 p-1 sm:text-sm">
                ...
                für Konstruktions- wissenschaften &apo;Eduardo Torroja&apo; in Spanien.
              </p>
            </div>
