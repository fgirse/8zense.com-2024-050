...
export default function NavbarProtected() {
  ...
  return (
    <div className="mx-auto flex  w-full max-w-7xl justify-between px-4 py-5 text-3xl text-neutral-800 uppercase">
      {/* left side  */}
      ...
      <LogoEZ/>
        ...
        <div className="hidden md:flex items-center gap-4 transition-all">
          {navItems.map((d, i) => (
            ...
            >
              <p className="text-4xl py-1 px-2 flex cursor-pointer items-center xl:text-[1.13rem] gap-2 font-black  text-neutral-800 hover:border-b-4  hover:border-neutral-800   ">
                <span>{d.label}</span>
                {d.children && (
